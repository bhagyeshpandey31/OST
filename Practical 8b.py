                   ...
                   for index2, stack2 in enumerate(self.first_stack):
                       if index != index2:
                           curr_table, move=self.valid_state_move(self.first_stack, index, index2)
                               new_state = State(curr_table,
                                                 self.second_stack, self.total_num,copy.copy(self.moves))
